...
use rand::Rng;
use urnenmodell::join::Joiner;
use urnenmodell::list::List;
use urnenmodell::map::Mapper;
use urnenmodell::Urne;
use urnenmodell::Urnenmodell;
...
where
	P::Item: Display,
{
	for e in pool.choose_multiple(rng, 3) {
		println!("{}", e);
	}
}
